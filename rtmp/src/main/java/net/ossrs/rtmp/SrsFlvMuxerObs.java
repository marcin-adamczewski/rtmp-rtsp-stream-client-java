...
public class SrsFlvMuxerObs {
     ...
     * constructor.
     */
    public SrsFlvMuxerObs(ConnectCheckerRtmp connectCheckerRtmp, RtmpPublisher publisher) {
        this.connectCheckerRtmp = connectCheckerRtmp;
        this.publisher = publisher;
        handler = new Handler(Looper.getMainLooper());
    }

    public SrsFlvMuxerObs(ConnectCheckerRtmp connectCheckerRtmp) {
